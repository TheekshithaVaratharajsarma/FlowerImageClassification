...
model = flower_recognition_model_var2.build(input_shape=input_shape, classes=no_classes)
...
with open('training_history_var2.txt', 'w') as f:
...
with open('evaluation_output_var2.txt', 'w') as f:

...
model = FlowerRecognitionModelWithDropout.build(input_shape=input_shape, classes=no_classes)
...
with open('training_history_var1.txt', 'w') as f:
...
with open('evaluation_output_var1.txt', 'w') as f:
